...
while True:
    fh = raw_input('Enter n for sample distribution: ')
    if fh[0] == '#':
        continue
    if fh == 'ya':
        break
    ...
    print('----------------------------------------------------------------')
    print ' '
    anyvalue = raw_input('Enter point estimate or Population Mean for T-test: ')
    if anyvalue[0] == '#':
        continue
    if anyvalue == 'ya':
        break
    ...
    while True:
        ...
        alph=raw_input('Enter alpha for One-Sample t-Test or "no" to continue: ')
        ...
        print 't-table =', tvalue

        print ' '

        tstat = (newmean - mean)/(standarderror/math.sqrt(newn))

        print 't-statistic =', tstat

        print ' '

        pvalue = stats.t.sf(np.abs(tstat), newn-1)*2

        print 'p-value =', pvalue

        print ' '

        #   print 'NOTES:\n- The larger the value of the sample mean (m), the stronger the evidence that m > M.\n- The smaller the value of the sample mean (m), the stronger the evidence that m < M.\n- The further the value of m from M in either direction, the stronger the evidence that m != M.\n'
